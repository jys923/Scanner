...
public class PhotosActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = (Button) findViewById(R.id.photo_add_btn);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PhotosActivity2.this, MainActivity.class);
...
//        });
        ...
        gridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int i, long l) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(PhotosActivity2.this);
                dialog.setTitle("삭제");
                ...
                dialog.setPositiveButton("지워라",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                Toast.makeText(PhotosActivity2.this, (((GridViewItem) adapter.getItem(i)).getTitle()) + "로컬-지웠다", Toast.LENGTH_SHORT).show();
                                /**서버디비지우기**/
                                                    ...
                                                    while (true) {
                                                        ...
                                                        if (line == null) {
                                                            ...
                                                            runOnUiThread(new Runnable() {
                                                                @Override
                                                                public void run() {
                                                                    Toast.makeText(PhotosActivity2.this, s + "-서버에서 이미 지워짐", Toast.LENGTH_SHORT).show();
                                                                }
                                                            });
                                                            ...
                                                            runOnUiThread(new Runnable() {
                                                                @Override
                                                                public void run() {
                                                                    Toast.makeText(PhotosActivity2.this, s + "-서버에서 지워짐", Toast.LENGTH_SHORT).show();
                                                                }
                                                            });
                                                        }
                                                    }
...
//                                }
    ...
    protected void onResume() {
         ...
         * **/
        adapter.setClear();
        helper = new MySQLiteOpenHelper(PhotosActivity2.this, // 현재 화면의 context
                "albums.db", // 파일명
                null, // 커서 팩토리
                1); // 버전 번호
        try {
